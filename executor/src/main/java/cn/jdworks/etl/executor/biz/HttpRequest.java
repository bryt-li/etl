...
public class HttpRequest {
	...
	private static final Log LOG = Logs.getLog(HttpRequest.class);
	...
	public static String sendTaskLogs(String url, List<TaskLog> sendLogs, int connectTimeout, int readTimeout) {
		...
		try {
			...
			outputStream.writeObject(sendLogs);
